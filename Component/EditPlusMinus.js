...
export default function EditPlusMinus(props) {
...
const handleMinus=()=>{
 ...
 {props.item.value==0?<Button title="ADD TO CART" onPress={handlePlus} />:
...
<Text style={{fontSize:30,marginLeft:10,marginRight:10,color:'#000'}}>{props.item.value}</Text>
